...
class Campaign(db.Model):
    ...
    used_amount = db.Column(db.BIGINT, primary_key=True)
    usage_rate = db.Column(db.FLOAT, nullable=False)
    budget = db.Column(db.BIGINT, primary_key=True)
    bid_amount = db.Column(db.BIGINT, primary_key=True)
    ...
    user_update = db.Column(db.BIGINT(255), nullable=False)
